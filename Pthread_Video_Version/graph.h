...
// Define ThreadData
struct ThreadData {
    alignas(64) int width;
    alignas(64) int height;
    alignas(64) int startRow;
    alignas(64) int endRow;
    alignas(64) std::vector<Object*>* scene;
    alignas(64) cv::Mat image;
